(function (exports) {
  ...
  validate.defaults = {
      ...
      /**
       * <p>
       * When {@link #cast} is <code>true</code>,
       * this option, when set to true, treats empty string as valid integer.
       * </p><p>
       * <em>Default: <code>false</code></em>
       *</p>
       */
      treatEmptyStringAsInteger: false
  };
  ...
  function validateProperty(object, value, property, schema, options, errors) {
    ...
    if (options.cast) {
      if ('integer' === schema.type || 'number' === schema.type) {
        if(value === '' && options.treatEmptyStringAsInteger || value !== '' && value == +value) {
          value = +value;
